...
# частотные слова очищены от стоп-слов, программа умеет работать для русского и английского языков
# на вход пользователь дает язык, сколько слов он хочет и сам статью
