...
def get_html(path, name):
    pathToScript = r'C:\Users\kseni\AppData\Local\Programs\Python\Python38-32\Scripts\pdf2txt.py'
    pathPDFinput = os.path.join(path)
    pathHTMLoutput = os.path.join(name)
    os.system(r'C:\Users\kseni\AppData\Local\Programs\Python\Python38-32\python.exe {} -o {} -S {} -t html'.format(pathToScript, pathHTMLoutput, pathPDFinput))
